...
bindCommand(keyboard0, make, control, "v", TO, "Menu::Display(menuChat);");
...
bindCommand(keyboard0, make, alt, "k", TO, "KillsLog::Save();");
bindCommand(keyboard0, break, alt, "k", TO, "");
bindCommand(keyboard0, make, alt, "r", TO, "KillsLog::Reset();");
bindCommand(keyboard0, break, alt, "r", TO, "");
bindCommand(keyboard0, make, "period", TO, "SnipeHud::zoom(in);");
bindCommand(keyboard0, make, "comma", TO, "SnipeHud::zoom(out);");
bindCommand(keyboard0, make, ";", TO, "SnipeHud::display(toggle);");
bindCommand(keyboard0, break, ";", TO, "null();");
bindCommand(keyboard0, make, "l", TO, "SnipeHud::sensitivity(true);");
bindCommand(keyboard0, break, "l", TO, "SnipeHud::sensitivity(false);");
bindCommand(keyboard0, make, "numpad0", TO, "fakedeath(33);");
bindAction(mouse0, xaxis0, TO, IDACTION_YAW, Flip, Scale, 0.000645);
bindAction(mouse0, yaxis0, TO, IDACTION_PITCH, Flip, Scale, 0.000645);
